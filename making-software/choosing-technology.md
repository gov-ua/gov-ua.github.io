...
Це інформація тільки для допомоги, не використовуйте її як керівництво до дій.
...
------------------------
Припустимо, що більшість ваших технологічних варіантів можуть або будуть змінюватися, особливо на ранніх стадіях розвитку, наприклад:
...
На перший день проекту ви просто не зможете знати стільки щоб якумога найкраще обрати вирну технологію. Нормально припускати обгрунтованні припущення на цьому етапі.
...
- Продуктивність на очікуванному оточенні;
...
- Обмежить швидкість розробки продукту в майбутньому, наприклад якщо зявиться ідеально підходяща технологія котра не сумісна з вибором попередньої технології.
